	...
	override function update(elapsed:Float)
	{
		...
		if (doInput)
		{
			...
			if (FlxG.keys.pressed.CONTROL && FlxG.keys.justPressed.D)
			{
				...
				{
					deletedNotes.push([selectedBoxes.members[i].connectedNote.strumTime,selectedBoxes.members[i].connectedNote.rawNoteData,selectedBoxes.members[i].connectedNote.sustainLength,selectedBoxes.members[i].connectedNote.noteType]);
				...
				if (FlxG.keys.pressed.CONTROL && FlxG.keys.justPressed.C)
				{
					if (selectedBoxes.members.length != 0)
					{
						...
						for(i in selectedBoxes.members)
							copiedNotes.push([i.connectedNote.strumTime,i.connectedNote.rawNoteData,i.connectedNote.sustainLength,i.connectedNote.isAlt,i.connectedNote.beat,i.connectedNote.noteType]);
